...
function redzlib:MakeWindow(Configs)
    ...
    -- Parâmetros para scroll
    local maxVisibleItems = 10
    local itemHeight = 22
    local totalOptions = #DOptions
    local visibleItems = math.min(maxVisibleItems, totalOptions)
    local dropdownHeight = visibleItems * itemHeight

    local Button, LabelFunc = ButtonFrame(Container, DName, DDesc, UDim2.new(1, -180))

    local ScrollFrame = Instance.new("ScrollingFrame")
    ScrollFrame.Name = "DropdownScrollFrame"
    ScrollFrame.Size = UDim2.new(1, 0, 0, dropdownHeight)
    ScrollFrame.CanvasSize = UDim2.new(0, 0, 0, totalOptions * itemHeight)
    ...
    local function RemoveOption(index)
    ...
    local function CalculateSize()
        ...
        visibleItems = math.min(maxVisibleItems, totalOptions)
        dropdownHeight = visibleItems * itemHeight
        ScrollFrame.Size = UDim2.new(1, 0, 0, dropdownHeight)
        ScrollFrame.CanvasSize = UDim2.new(0, 0, 0, totalOptions * itemHeight)
    end
